...
# 2026-09-03 Leo：「機器人、bitcoin、衛星幫我放到後面，AI 相關移前面」。
# 前段＝AI 供應鏈本體（伺服器→材料→電源散熱→電力→光通訊→封裝基板），大致照
# 老墨三段時程的上下游順序排；後段＝主題型、跟 AI 資本支出關聯較遠的三條。
# ⚠️ 這個順序同時決定看板區塊順序、頂端錨點導覽、以及 alert_telegram 推播的分組順序
# （三處都 import 這一份，不要各自再排一次）。
CHAIN_ORDER = ["AI 伺服器", "AI 材料/被動元件", "AI 電源/散熱", "AI 電力/核能",
               "矽光子/光通訊", "PCB/ABF 載板", "玻璃基板/TGV", "關鍵金屬/原物料", "太陽能",
               "機器人", "低軌衛星", "Bitcoin→AI 機房"]
CHAIN_ICON = {"AI 伺服器": "🖥️", "矽光子/光通訊": "🔦", "機器人": "🤖",
              "低軌衛星": "🛰️", "AI 電力/核能": "⚡", "太陽能": "☀️",
              "Bitcoin→AI 機房": "⛏️", "玻璃基板/TGV": "🧊", "關鍵金屬/原物料": "🧠",
              "AI 材料/被動元件": "🧱", "AI 電源/散熱": "🔌", "PCB/ABF 載板": "🟩"}
SIG_CLASS = {"🔴": "sell", "🟢": "buy", "🔵": "hold", "🟡": "watch", "⚪": "watch"}
# 2026-09-03 Leo：看板時程軸（老墨三段時程報告行動 4）。每條鏈標「主行情落在哪一段」，
# 對照 RRG 象限看「時間到了沒、資金進來了沒」。只標老墨表有涵蓋的鏈，其餘不標。
# 依據見 報告檔/老墨產業趨勢三段時程；改時程要連報告一起改，別只改這裡。
CHAIN_PHASE = {
    "AI 伺服器":       "2026–27 供給瓶頸",
    "AI 材料/被動元件": "2026–27 供給瓶頸",
    "矽光子/光通訊":   "2026–27 供給瓶頸 → 2028+ CPO",
    "AI 電源/散熱":    "2027–28 效率分化",
    "玻璃基板/TGV":    "2027–28 效率分化 → 2028+ CoPoS",
    "低軌衛星":        "2028+ 衛星 AI",
}
...
TW_NAME = {
    ...
    "6443": "元晶", "8046": "南電",
    # PCB/ABF 載板鏈（2026-09-22 第 12 鏈）
    "4958": "臻鼎-KY", "3044": "健鼎", "3715": "定穎投控", "6672": "騰輝-KY",
    "3167": "大量", "7795": "長廣",
