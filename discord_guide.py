...
SECTIONS = [
    ...
    ("## 📊 #每日戰情（公開）",
     [
         "**每日戰情**　平日 08:45　龐統發情報、孔明發判斷，五段＋附錄：",
         "-# ①大盤／總經　②今日訊號異動（SuperTrend 翻面、AI 轉買賣、🚦**進出燈號倉買賣動作**）　"
         "③投資長進場機會（非持股評估）　④研究員筆記（產業翻象限）　"
    ...
    ("## 🤖 Bot（隆中對伺服器任一頻道，打 / 會跳出）",
     [
         "**/查 代號:2454**　即時四燈／風報比／RS60／類股象限＋最近投資長判斷。"
         "守備清單內秒回，其他股票約 3–8 秒",
         "-# 下一個：**/交易**　一行記一筆交易＋自動附當時系統快照（燈號/象限/投資長），"
         "跟現在的 trade_journal 同一套；交易紀錄檔案在 obis 04_AI Report/Investment",
     ]),
...
WHATS_NEW = (
    ...
    [
        ...
        "≥3 燈＋風報比≥1 進場、ST 翻空賣半、RS60 跌破全出、7 天冷卻。9/2 首日買進 8 檔各 1/8。"
        "買賣動作從今天起進 #每日戰情 第②段。",
        "",
        "**2. 趨勢倉 ATR 改回 Wilder**",
        ...
        "",
        "**3. 進出燈號頁加類股象限欄**",
        "-# 純顯示不當門檻（燈四已是個股 RS；三週期象限常互相打架）。TradingView 按代號查類股，"
        "跟輪動頁同源。",
        "",
        "**4. 老墨三段時程：查證＋落地**",
        ...
        "報告與簡報 PDF 在 obis 04_AI Report/Investment。",
        "",
