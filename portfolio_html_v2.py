...
from portfolio_html import usd, cls, holding_rows, OBIS
...
<p>先挑「好公司」，再等「便宜」才買。三道關卡：
① 產業龍頭（同產業市值前3）② ROE ≥ 15% ③ 盈再率 &lt; 80%（洪瑞泰最看重）。<br>
通過品質三關後，<b>現價 ≤ 俗價（EPS×12）</b>才買，取品質分前 30，排除照妖鏡（EPS估降/高負債）。<b>每季</b>隨財報更新。</p>
<hr>
