...
<p style="margin:4px 0"><b>🏭 產業鏈全（動能／成長派）</b><br>
...
三因子各自排名正規化加總 → <b>守備清單</b>。「產業鏈全」＝<b>七鏈完整清單全買、等權重</b>（約 80+ 檔）；
下方「7 鏈明細」＝各鏈分開比。<b>每週日重篩</b>，量沒進來的會被換掉。<br>
<span style="color:#8ab4f8">2026-07-28 由「每鏈取前 2（約 13 檔）」改回全買：5.5 年回測顯示取前 2 過度集中，回撤 −55.9% 比單一鏈還差。<b>Bitcoin→AI 機房</b>該鏈合計限重 10%（回測 MDD −94%）。</span></p>
<hr style="border-color:#2a2e35;margin:10px 0">
<p style="margin:4px 0"><b>⚡ 產業鏈+趨勢（選股＋擇時）</b><br>
拿「產業鏈全」同一批股，再用 <b>SuperTrend</b>（TradingView 同款趨勢線）過濾：
<b>只抱「多頭（綠燈）」的，翻空（紅燈）就先不持有</b>。測「選股好之後，加上趨勢擇時會不會更賺、回檔少」。<br>
<span style="color:#8ab4f8">此倉<b>每日檢查</b>但用<b>週線</b> SuperTrend 判斷（公式與參數 ATR10×3 不變，只把 K 棒由日改週）。2026-07-28 依回測改：日線 32 次賣出有 24 次(75%)賣完股價續漲，訊號雜訊過高；週線同期只 10 次訊號。其餘倉維持每週日調倉。</span></p>
<hr style="border-color:#2a2e35;margin:10px 0">
...
<p class="sub" style="margin:8px 0 0">一句話：<b>產業鏈全＝追「現在強、資金在進」；產業鏈+趨勢＝同股再加週線趨勢擇時；巴菲特＝撿「便宜的好公司」</b>。
