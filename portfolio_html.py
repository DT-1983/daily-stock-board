...
<hr style="border-color:#2a2e35;margin:10px 0">
<p style="margin:4px 0"><b>⚙️ 共通機制</b>：兩套各投 <b>{usd(base)}</b>，<b>等權重</b>買進（每檔金額相同）。
台股以<b>即時匯率</b>（現 1美元={fx}台幣）換美金，全部美金加總才能比。
<b>市值 ＝ Σ 股數×現價，損益 ＝ 市值 − 本金</b>。每週跟新清單調倉（賣退榜、買新進），淨值接續累計。</p>
